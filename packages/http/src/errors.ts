...
//
// fetchOnStream and the response/chunked parsers throw HttpProtocolError
// for everything that's an HTTP-layer framing problem (bad status line,
// multiple Content-Length, chunked size garbage, header validation, …).
