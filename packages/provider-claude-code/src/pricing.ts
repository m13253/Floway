...
// Per-key lookup; modelKey is the raw dated upstream id we persist in
// usage rows. Unknown keys (forward-compat with a future Anthropic dated id)
// read as null and the dashboard treats them as cost 0.
