...
import type { CatalogModel, Provider, UpstreamProviderKind } from '@floway-dev/provider';
...
const toControlPlaneModel = (model: CatalogModel, instances: readonly Provider[]): ControlPlaneModel => ({
  ...toPublicModel(model),
