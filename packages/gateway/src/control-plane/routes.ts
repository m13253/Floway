...
export const controlPlaneRoutes = new Hono()
  ...
  .route('/api', new Hono()
    ...
    .post('/upstreams/:id/probe-quota', zValidator('json', claudeCodeProbeQuotaBody), claudeCodeProbeQuota)
