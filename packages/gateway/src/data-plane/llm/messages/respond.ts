...
const tokenUsageFromMessagesUsage = (u: MessagesUsageLike) => tokenUsage({
  input: u.input_tokens ?? 0,
  input_cache_read: u.cache_read_input_tokens ?? 0,
  input_cache_write: u.cache_creation?.ephemeral_5m_input_tokens ?? u.cache_creation_input_tokens ?? 0,
  input_cache_write_1h: u.cache_creation?.ephemeral_1h_input_tokens ?? 0,
