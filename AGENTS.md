...
concrete impls and its own entry. `packages/gateway` (the gateway core)
imports only platform contracts and is ESLint-prohibited from reaching
into any `apps/platform-*`.
