// DeepSeek wire-dialect normalizer for the Responses target. Always-
// attached; flag-gated by `vendor-deepseek`. Runs last among target
// interceptors so it has the final say on the outbound wire body.
//
