...
// downstream, at a modest file-size premium over the default. Confirmed on
// real traffic: the production Cloudflare Images encoder at q82 matches
// local cwebp within <0.1 dB PSNR. References:
